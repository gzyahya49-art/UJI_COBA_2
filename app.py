...
try:
    ...
    st.error("Gagal memuat file 'Log_Data_Bayam_Brazil_1440_2026.xlsx'. Pastikan nama file sesuai dan berada di direktori yang sama.")
    st.stop()
...
st.markdown("""
    <div class="header-neon-box">
        <h1 style='margin: 0; padding-bottom: 5px; font-size: 32px;'>🌿 SMART BOTANICAL DASBOARD - BRAZILEARN ONE HYDROTECH </h1>
...
# ==================================
# BAGIAN 3: VISUALISASI GRAFIK TREN MULTI-TIME
# ==================================
